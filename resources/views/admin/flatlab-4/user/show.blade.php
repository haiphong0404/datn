                    ...
                    <form action="{{ route('user.show',$user->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        @if ($user->avatar_img)
                            <div class="mb-3">
                                ...
                                <img src="{{ asset('uploads/avatars/' . $user->avatar_img) }}" alt="Avatar" class="img-thumbnail" style="max-width: 150px;">
                            </div>
                        @endif
                        ...
                        <div class="d-flex">
                            ...
                            <a href="{{ route('user.edit', $user->id) }}" class="btn btn-warning flex-fill me-1">Chỉnh sửa</a>
                        </div>
                    </form>
                </div>
            </div>
