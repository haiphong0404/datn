...
<!-- Mirrored from htmldemo.net/pullman/pullman/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Aug 2024 14:08:17 GMT -->
<head>
    <meta charset="utf-8">
                                        ...
                                        <li class="mini-cart-wrap">
                                            ...
                                            <div class="cart-list-wrapper">
                                                <ul class="cart-list">
                                                    <li>
                                                        <div class="cart-img">
                                                            <a href="product-details.html"><img src="{{ asset('assets')}}/client/assets/img/cart/cart-1.jpg" alt=""></a>
                                                        </div>
                                                        <div class="cart-info">
                                                    ...
                                                    <li>
                                                        <div class="cart-img">
                                                            <a href="product-details.html"><img src="{{ asset('assets')}}/client/assets/img/cart/cart-2.jpg" alt=""></a>
                                                        </div>
                                                        <div class="cart-info">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="payment-method-list">
                            <img src="{{ asset('assets')}}/client/assets/img/payment-2.png" alt="payment method">
                        </div>
                            ...
                            <div class="col-lg-5">
                                <div class="product-large-slider">
                                    <div class="pro-large-img">
                                        <img src="{{ asset('assets')}}/client/assets/img/product/product-details-img1.jpg" alt="product-details" />
                                    </div>
                                    <div class="pro-large-img">
                                        <img src="{{ asset('assets')}}/client/assets/img/product/product-details-img2.jpg" alt="product-details" />
                                    </div>
                                    <div class="pro-large-img">
                                        <img src="{{ asset('assets')}}/client/assets/img/product/product-details-img3.jpg" alt="product-details" />
                                    </div>
                                    <div class="pro-large-img">
                                        <img src="{{ asset('assets')}}/client/assets/img/product/product-details-img4.jpg" alt="product-details" />
                                    </div>
                                </div>
...
============================================ -->
    ...
    <!-- masonry  -->
    <script src="{{ asset('assets')}}/client/assets/js/plugins/masonry.pkgd.min.js"></script>
    <!-- mailchimp active js -->
...
<!-- Mirrored from htmldemo.net/pullman/pullman/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Aug 2024 14:08:38 GMT -->
</html>