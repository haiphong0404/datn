                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="variants">
                            <div class="variant mb-3">
                                ...
                                <label for="variant_images_0" class="form-label">Hình ảnh biến thể</label>
                                <input type="file" name="variant_images_0[]" class="form-control mb-2" accept="image/*" multiple>
