            ...
            <div class="card shadow-sm">
                <header class="card-header">
                    <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                        <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Tạo Liên Hệ Mới</h1>
                        <nav class="flex-shrink-0 my-2 my-sm-0 ms-sm-3" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="{{ route('admin.contacts.index') }}" style="color: inherit;">Liên Hệ</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">Tạo Mới Liên Hệ</li>
                            </ol>
                        </nav>
                    </div>
                </header>
                    ...
                    <form action="{{ route('admin.contacts.store') }}" method="POST">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Nhập tên" value="{{ old('name') }}">
                            </div>
                            @error('name')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" placeholder="Nhập email" value="{{ old('email') }}">
                            </div>
                            @error('email')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="mb-3 d-flex">
                            ...
                            <button type="submit" class="btn btn-primary btn-lg flex-fill">Tạo Mới</button>
                        </div>
                    </form>
                </div>
            </div>
